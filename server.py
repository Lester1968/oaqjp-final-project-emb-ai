...
Emotion Detection function as a web service.
"""
...
def sent_analyzer():
    """
    Read the text to analyze from the request query string, run emotion
    detection on it, and return a formatted description of the emotion
